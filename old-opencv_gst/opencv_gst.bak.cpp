...
void HOGDetect(int, void*)
{
  while (true) {
    ...
    hog.detectMultiScale(src, found, 0, Size(8,8), Size(32,32), double(hogScale/100.0), 2);
...
void h_circles() {
  ...
  createTrackbar( "Min Dispersion:", window_name, &dispersionDist, 200, CircleHoughs);
  /// Show the image
  CircleHoughs(0, 0);
